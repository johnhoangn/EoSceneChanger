...
namespace EoJSON
{
    // StatusObject myDeserializedClass = JsonConvert.DeserializeObject<StatusObject>(myJsonResponse); 
    public class Game
    {
    ...
    public class Color
    {
        public List<int> saberA { get; set; }
        public List<int> saberB { get; set; }
        public List<int> environment0 { get; set; }
        public List<int> environment1 { get; set; }
        public object environment0Boost { get; set; }
        public object environment1Boost { get; set; }
    ...
    public class PlayerSettings
    {
        ...
        public double saberTrailIntensity { get; set; }
